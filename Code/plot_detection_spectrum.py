...
ref = energy_sampler(E, 2e53, 0.05, 'proportional', detector, 'normal', distance)
...
plt.title(f'Detection spectrum Super-K for {int(distance/1000)} Kpc Supernova', fontsize = 16)
plt.xlim(0, 70)
