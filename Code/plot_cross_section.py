...
cross_coherent_Ge = cs.diff_cross_section_CEnuNS(9.5, x, 9.314e8*76/1e9, 32, 32)
cross_coherent_Xe = cs.diff_cross_section_CEnuNS(16, x, 9.314e8*132/1e9, 54, 54)
cross_coherent_Si = cs.diff_cross_section_CEnuNS(4.2, x, 9.314e8*28/1e9, 14, 14)

fig = plt.figure(figsize=(10,8))
plt.plot(x, cross_coherent_Ge, color = 'orange', lw = 2, ls = '--',
        label = r'CE$\nu$NS $^{76}$Ge')
plt.plot(x, cross_coherent_Xe, color = 'orange', lw = 2,
        label = r'CE$\nu$NS $^{132}$Xe')
